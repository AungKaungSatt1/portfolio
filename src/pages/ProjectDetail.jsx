...
export default function ProjectDetail() {
    ...
    const openEnvelope = (e, envelope) => {
        if (e.target.classList.contains("clicked")) {
            ...
            setTimeout(() => {
                e.target.children[3].classList.remove("transform-[rotateX(180deg)]", "-z-3");
            }, 500);
        } else {
            e.target.classList.add("clicked");
            e.target.children[3].classList.add("transform-[rotateX(180deg)]", "-z-3");
            setTimeout(() => {
            ...
            <div className="h-[587px] w-full mb-[100px]">
                <div className="mx-auto w-[90%] mt-[100px] [&>*]:transition-all [&>*]:duration-500 [&>*]:ease-in-out">
                    <h1 className="text-[3em] font-bold">
                        {project.name} <strong className="text-(--additional-color)">.</strong>
                    </h1>
                    ...
                    <div className="w-full bg-linear-90 from-[#E9E9E9] to-(--secondary-color) shadow-lg lg:py-[40px] lg:px-[30px] rounded-[15px] mb-[30px]">
                        <img
                            className="lg:h-[440px] md:h-[360px] mx-auto rounded-[15px] w-full"
                            src={project.photo}
                            alt={project.name}
                            loading="lazy"
                        />
                ...
                <div className="grid grid-cols-12 w-[90%] mx-auto mb-[75px]">
                    <div className="col-span-12 my-[30px] h-[100px] mx-auto p-[15px] rounded-[10px] w-full grid grid-cols-12 [&>*]:items-center">
                        ...
                        <div className="inline-flex flex-col col-span-4 border-s border-e border-s-gray-300 border-e-gray-300">
                            ...
                            <span className="cursor-pointer inline w-[35px] hover:text-(--additional-color)">
                                <GithubLogo size="2em" />
                            </span>
                        </div>
                        <div className="inline-flex flex-col col-span-4">
                    ...
                    <div className="col-span-12 flex items-center flex-wrap justify-between w-full [&>*]:mx-auto [&>*]:col-span-4 [&>*]:w-[300px] [&>*]:h-[200px] [&>*]:relative [&>*]:perspective-normal">
                        {envelopes.map((envelope, index) => {
                            return (
                                <div key={envelope} className="mb-[100px]">
                                    ...
                                    >
                                        <div className="bg-[#acacf3] w-full h-full -z-4 absolute top-0"></div>
                                        <div className="bg-(--primary-color) shadow-lg w-[80%] h-full -z-2 absolute top-0 left-8 text-[0.9em] p-[10px]">
                                            {letters[index]}
                                        </div>
                                        <div className="w-full h-full border-t-transparent border-t-[100px] border-s-[150px] border-e-[150px] border-e-(--secondary-color) border-s-(--secondary-color) origin-top absolute -z-1 top-0"></div>
                                        <div className="w-full h-full border-t-[120px] border-t-[#acacf3] border-s-[150px] border-e-[150px] border-s-transparent border-e-transparent origin-top absolute top-0 -z-1 transition-all ease-in-out duration-700 cursor-pointer"></div>
                                        <div className="text-center absolute top-25 w-full -z-1">
                                            <span className="text-start inline-block mx-auto bg-[#c785ec] border-2 border-(--secondary-color) p-[5px] rounded-full [&>*]:inline-block w-[39px] transition-all duration-500 ease-in-out">
                                                <StarFour
                                        ...
                                        <h1 className="text-center text-[1.5em] absolute -bottom-10 w-full">
